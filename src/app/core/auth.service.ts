  ...
  public permit: Permit =
    {
      ...
      productionRawMaterialsCreateButton: false,
      productionRawMaterialsSubstractAction: false,
      productionRawMaterialsEditAction: false,
      productionRawMaterialsDeleteAction: false,
      productionFinishedProductsButton: false,
      productionFinishedProductsCreateButton: false,
      productionFinishedProductsTableSale: false,
      productionFinishedProductsEditAction: false,
      productionFinishedProductsDeleteAction: false,
      ...
      cashDebtsToPayTotalPayAction: false,
      cashDebtsToPayPartialPayAction: false,
